...
if(isset($_POST['submit-studentform'])) { 
    ...
    if($success)
 {
        ...
        $data['studentqualification'] = $qualification;
        ...
        //log them in
        $session->login($studentemail, $studentpassword);
...
if(isset($_POST['submit-employerform'])) { 
    ...
    if($success)
 {
        ...
        //log them in
        $session->login($employeremail, $employerpassword);
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-2" id="studentregister" >
                <form action="register.php" method="post" role="form">
                    ...
                    <button type="submit" class="btn btn-default" name="submit-studentform">Submit</button>
                </form>
            </div>
            <div class="col-md-6 col-md-offset-2" id="employerregister" style="visibility: hidden">
                <form action="register.php" method="post" role="form">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="<?php echo $companyname; ?>"  class="form-control" id="companyname" name="comapnyname">
                    </div>
                    ...
                    <button type="submit" class="btn btn-default" name="submit-employerform">Submit</button>
                </form>
            </div>
        </div>
